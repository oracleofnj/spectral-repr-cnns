...
We present a plot of the average information dissipation for the CIFAR-10 <<<test>>> set. The y-axis displays the L2 error normalized by the norm of the input images. The red line indicates the error rate achieved by max-pooling 2x2 regions with a stride of 2, which is the minimum downsampling that max-pooling can perform. 
...
Optimization Convergence Speed (Results - Section 5.1.3)

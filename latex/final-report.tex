...
The architecture of our spectrally-pooled CNN is described in \textbf{FIGURE 1 - AARSHAY ONE OF YOUR CHARTS GOES HERE}. The TensorFlow network diagram is showin in \textbf{FIGURE 2 - WE SHOULD CHANGE THE FIGURE NUMBERS SO THEY GET UPDATED AUTOMATICALLY}. 
...
Both of these results were improvements on the results of our hyperparameter search; the best results obtained by random search were 27.63\% for CIFAR-10 and 66.68\% for CIFAR-100, respectively. The random search parameters appeared to start overfittin the data quite early; their training curve is shown in \textbf{FIGURE 3 BUT AUTONUMBER THIS.}
